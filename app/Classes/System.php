    ...
    public function config(){
        $data['homepage'] = [
            ...
            'value' => [
                ...
                'video_background' => ['type' => 'images', 'label' => 'Background Video'],
                'video_youtube_pc' => [
                    'type' => 'textarea', 
        ...
        $data['contact'] = [
         ...
         $data['intro'] = [
            'label' => 'Cấu hình Section Slide',
            'description' => 'Cài đặt đầy đủ thông tin chung của website. ',
            'value' => [
                'section_1_text' => ['type' => 'text', 'label' => 'Tiêu đề khối 1'],
                'section_1_link' => ['type' => 'text', 'label' => 'Đường dẫn Khối 1'],
                'section_2_number' => ['type' => 'text', 'label' => 'Số thành viên Khối 2'],
                'section_2_coach' => ['type' => 'text', 'label' => 'Số huấn luyện viên Khối 2'],
                'section_3_title' => ['type' => 'text', 'label' => 'Tiêu đề Video KHối 3'],
                'section_3_description' => ['type' => 'text', 'label' => 'Mô tả Video Khối 3'],
                'section_3_image' => ['type' => 'images', 'label' => 'Hình Ảnh Preview Video KHối 3'],
            ]
        ];
